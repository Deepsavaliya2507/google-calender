        ...
        <Modal.Body>
          ...
          <div className="fadeIn" style={{justifyContent:"center",display:"flex",flexDirection:"row",flexWrap:"wrap",marginHorizontal: "10px"}}>
            <div style={{margin: "6px"}}>
              <img alt="Step 1" src={step1} style={{width:"370px", borderRadius:"10px"}}/>
              <p style={{textAlign:"center"}}>Step 1: Click <i>Advanced</i></p>
            </div>
            <div style={{margin: "6px"}}>
              <img alt="Step 2" src={step2} style={{width:"370px", borderRadius:"10px"}}/>
              <p style={{textAlign:"center"}}>Step 2: Click <i>Go to googlycalendar.web.app (unsafe)</i></p>
            </div>
            <div style={{margin: "6px"}}>
              <img alt="Step 3" src={step3} style={{width:"370px", borderRadius:"10px"}}/>
              <p style={{textAlign:"center"}}>Step 3: Click <i>Allow</i> on the popup</p>
            </div>
            <div style={{margin: "6px"}}>
              <img alt="Step 4" src={step4} style={{width:"370px", borderRadius:"10px"}}/>
